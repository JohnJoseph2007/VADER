...
ttk.Label(mainframe, textvariable=pos).grid(column=1, row=4, sticky=(W, E))
ttk.Label(mainframe, textvariable=neu).grid(column=1, row=5, sticky=(W, E))
ttk.Label(mainframe, textvariable=neg).grid(column=1, row=6, sticky=(W, E))
